                ...
                <div class="col-lg-3">
                    <div class="card bg-light mb-3">
                        <div class="card-body mb-2 text-center">
                            <div>
                                <a href="{{ route('admin.edit') }}" role="button">
                                    <img src="{{
                                            asset('storage/img/'.Auth::user()->photo_profile)
                        ...
                        <div class="list-group list-group-flush text-center">
                            <a href="{{ route('admin.dashboard') }}"
                                class="list-group-item list-group-item-action  {{ Request::route()->getName() == 'admin.dashboard' ? 'active' : ''}}">Dashboard</a>
                            <a href="{{ route('admin.pengguna') }}"
                                class="list-group-item list-group-item-action  {{ Request::route()->getName() == 'admin.pengguna' ? 'active' : ''}}">Pengguna</a>
                            <a href="{{ route('admin.feed') }}"
                                class="list-group-item list-group-item-action  {{ Request::route()->getName() == 'admin.feed' ? 'active' : ''}}">Berita</a>
                            <a href="{{ route('admin.konsultasi') }}"
                                class="list-group-item list-group-item-action {{ Request::route()->getName() == 'admin.konsultasi' ? 'active' : ''}}">Konsultasi</a>
                            <a href="{{ route('admin.komunitas') }}"
                                class="list-group-item list-group-item-action {{ Request::route()->getName() == 'admin.komunitas' ? 'active' : ''}}">Komunitas</a>
                        </div>
                    </div>
                </div>
                @if(Request::route()->getName()== "admin.dashboard" ||
                Request::route()->getName()== "admin.pengguna" ||
                Request::route()->getName()== "admin.readPost")
