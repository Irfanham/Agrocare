                ...
                <form class="login-form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-3">
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Nama Lengkap')
                                }}</label>
                    ...
                    <div class="mb-3">
                        <div class="form-group row">
                            <label for="role" class="col-md-4 col-form-label text-md-right">{{ __('Pekerjaan')
                                }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="nohp" type="text" class="form-control @error('nohp') is-invalid @enderror"
                                    name="nohp" value="{{ old('nohp') }}" required autocomplete="nohp" autofocus>
